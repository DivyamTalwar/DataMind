...
hooks, evidence bookkeeping, and audit path. DB-GPT and RAGFlow are included
only on matched database or document subsets with the same model, data,
questions, and output budget.
...
We compare DataMind with a retry-only/direct baseline and, where the protocol
can be matched, DB-GPT or RAGFlow. We report completion, correct answer,
