...
This table provides matched external comparisons: DB-GPT on Table/SQL and RAGFlow on document/RAG tasks. Unsupported combinations are reported as N/A rather than scored as failures.

\begin{table}[t]
\centering\footnotesize
\caption{RQ1 matched-subset comparison with external systems.}
